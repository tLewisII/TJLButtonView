...
- (instancetype)initWithView:(UIView *)view delegate:(id <TJLButtonViewDelegate>)delegate images:(NSArray *)images buttonTitles:(NSArray *)titles {
    ...
    if(self) {
        ...
        self.buttonContainer = [[UIView alloc]initWithFrame:CGRectMake(CGRectGetMidX(self.bounds) - 125, CGRectGetMidY(self.bounds) - 125, 250, 250)];
        ...
        for(NSUInteger i = 0; i < images.count; i++) {
            ...
            b.frame = CGRectMake(CGRectGetMidX(self.buttonContainer.bounds) - 20, CGRectGetMidY(self.buttonContainer.bounds) - 20, 75, 75);
        ...
        self.closeButton.frame = CGRectMake(CGRectGetMidX(self.buttonContainer.bounds) - 20, CGRectGetMidY(self.buttonContainer.bounds) - 20, 75, 75);
        [self.closeButton setImage:[UIImage imageNamed:@"Redx.png"] forState:UIControlStateNormal];
        ...
        [UIView animateWithDuration:.5 animations:^{
            self.closeButton.frame = CGRectOffset(self.closeButton.frame, -15, -20);
        }];
...
- (void)setupBezierPaths {
    ...
    [topRightPath moveToPoint:CGPointMake(CGRectGetMinX(frame) + 124.5, CGRectGetMinY(frame) + 134)];
    ...
    [bottomRightPath moveToPoint:CGPointMake(CGRectGetMinX(frame) + 124.5, CGRectGetMinY(frame) + 134)];
    ...
    [bottomLeftPath moveToPoint:CGPointMake(CGRectGetMinX(frame) + 124.5, CGRectGetMinY(frame) + 134)];
    ...
    [topCenterPath moveToPoint:CGPointMake(CGRectGetMinX(frame) + 124.5, CGRectGetMinY(frame) + 134)];
    ...
    [topLeftPath moveToPoint:CGPointMake(CGRectGetMinX(frame) + 124.5, CGRectGetMinY(frame) + 134)];
...
- (void)setupCloseBezierPaths {
    ...
    [topRightPath addCurveToPoint:CGPointMake(CGRectGetMinX(frame) + 125.5, CGRectGetMinY(frame) + 132.96) controlPoint1:CGPointMake(CGRectGetMinX(frame) + 157.25, CGRectGetMinY(frame) + 134.96) controlPoint2:CGPointMake(CGRectGetMinX(frame) + 125.5, CGRectGetMinY(frame) + 132.96)];
    ...
    [bottomRightPath addCurveToPoint:CGPointMake(CGRectGetMinX(frame) + 124.5, CGRectGetMinY(frame) + 133.5) controlPoint1:CGPointMake(CGRectGetMinX(frame) + 131.75, CGRectGetMinY(frame) + 164.5) controlPoint2:CGPointMake(CGRectGetMinX(frame) + 124.5, CGRectGetMinY(frame) + 133.5)];
    ...
    [bottomLeftPath addCurveToPoint:CGPointMake(CGRectGetMinX(frame) + 125, CGRectGetMinY(frame) + 132.5) controlPoint1:CGPointMake(CGRectGetMinX(frame) + 117.75, CGRectGetMinY(frame) + 163.5) controlPoint2:CGPointMake(CGRectGetMinX(frame) + 125, CGRectGetMinY(frame) + 132.5)];
    ...
    [topCenterPath addCurveToPoint:CGPointMake(CGRectGetMinX(frame) + 124.5, CGRectGetMinY(frame) + 132) controlPoint1:CGPointMake(CGRectGetMinX(frame) + 147.25, CGRectGetMinY(frame) + 87.5) controlPoint2:CGPointMake(CGRectGetMinX(frame) + 124.5, CGRectGetMinY(frame) + 132)];
    ...
    [topLeftPath addCurveToPoint:CGPointMake(CGRectGetMinX(frame) + 125.5, CGRectGetMinY(frame) + 132.96) controlPoint1:CGPointMake(CGRectGetMinX(frame) + 93.75, CGRectGetMinY(frame) + 134.96) controlPoint2:CGPointMake(CGRectGetMinX(frame) + 125.5, CGRectGetMinY(frame) + 132.96)];
